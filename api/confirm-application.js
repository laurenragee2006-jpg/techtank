export default async function handler(req, res) {
  ...
  const response = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:32px;background:#0e0e0e;color:#0F172A;border-radius:12px">
          <p style="font-family:Georgia,serif;font-size:20px;margin:0 0 24px">lu<span style="color:#61d3f0">cent</span></p>
